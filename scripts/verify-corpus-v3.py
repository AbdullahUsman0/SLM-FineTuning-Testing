"""Fail-fast integrity checks for corpus v3 before a GPU training run."""
...
from local_slm_lab.corpus_v3 import validate_corpus_v3
...
def main() -> None:
    ...
    corpus = read_jsonl(corpus_root / "corpus-v3.jsonl")
    sft = [
    ...
    print("Corpus v3 integrity: PASS")
