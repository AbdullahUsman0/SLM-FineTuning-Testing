# Colab training: Qwen3.5-0.8B LoRA v4
...
clusters, Roman-Urdu variants, and targeted single-slot examples. The trainer
evaluates and saves each epoch, reloads the lowest validation-loss checkpoint,
and writes it to `best-adapter`.
